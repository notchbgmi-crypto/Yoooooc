...
# Bot Configuration
TOKEN = '8970164628:AAElFQh1RmU6wucyRz1_Ad3iMfVz-HYRmHI'
BACKUP_BOT_TOKEN = '8716243906:AAE4WfHHYQ4CGt2l9_9UsM4vsYWQjPtyWmI'
OWNER_ID = 8954667761
ADMIN_ID = 7097486151
YOUR_USERNAME = '@karanBhaiyaa'
UPDATE_CHANNEL = 'https://t.me/karanBhaiyaaa'
...
# If a Render Persistent Disk is mounted at /var/data (see render.yaml), use it automatically so
# the database and every user's uploaded bots survive redeploys/restarts. No setup needed —
# this is fully automatic and falls back to the normal folder (e.g. on Termux) if it's absent.
